...
export function previewFile(file, elementToAppend, isDelete = false, isToSee = false, handleDelete = null, handleToSee = null) {
    ...
    reader.onloadend = function() {
        ...
        if(isToSee) {
            ...
            `
            eye.addEventListener('click', handleToSee);
            div.append(eye);
        }
